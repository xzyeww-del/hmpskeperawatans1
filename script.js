...
class PengurusModal {
    ...
    openModal(card) {
        ...
        // Populate modal content (guard elements in case different modal markup exists)
        ...
        // Prefer group-photo in the modal when available
        if (fotoBersamaEl && (data.fotoBersama )) {
            fotoBersamaEl.src = data.fotoBersama  || '';
...
console.log('%c Developed HMPS Ilmu Keperawatan S1 UMP ', 'color: #667eea; font-size: 12px;');
